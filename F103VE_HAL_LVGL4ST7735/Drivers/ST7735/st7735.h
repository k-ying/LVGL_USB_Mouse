...
#define ST7735_RES_Pin       RST_Pin
#define ST7735_RES_GPIO_Port RST_GPIO_Port
#define ST7735_CS_Pin        CS_Pin
#define ST7735_CS_GPIO_Port  CS_GPIO_Port
#define ST7735_DC_Pin        RS_Pin
#define ST7735_DC_GPIO_Port  RS_GPIO_Port
...
char *reverse(char *s);
char *My_Itoa(int n);
void ST7735_lvgl_Fill(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color);
